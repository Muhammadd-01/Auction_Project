...
namespace Auction_Project.Migrations
{
    ...
    [Migration("20250418065240_categories")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Auction_Project.models.Auction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ElectronicsItemID")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("FurnituresItemID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ElectronicsItemID");

                    b.HasIndex("FurnitureId");

                    b.HasIndex("FurnituresItemID");
            ...
            modelBuilder.Entity("Auction_Project.models.Electronics", b =>
                {
                    ...
                    b.Property<string>("Electronic_cover")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Auction_Project.models.Furnitures", b =>
                {
                    ...
                    b.Property<string>("Furniture_cover")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Auction_Project.models.Auction", b =>
                {
                    b.HasOne("Auction_Project.models.Books", "Books")
                        .WithMany()
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Auction_Project.models.Books", null)
                        .WithMany("Auctions")
                        .HasForeignKey("BooksItemID");

                    b.HasOne("Auction_Project.models.Electronics", "Electronics")
                        .WithMany()
                        .HasForeignKey("ElectronicsId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Auction_Project.models.Electronics", null)
                        .WithMany("Auctions")
                        .HasForeignKey("ElectronicsItemID");

                    b.HasOne("Auction_Project.models.Furnitures", "Furnitures")
                        .WithMany()
                        .HasForeignKey("FurnitureId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Auction_Project.models.Furnitures", null)
                        .WithMany("Auctions")
                        .HasForeignKey("FurnituresItemID");
